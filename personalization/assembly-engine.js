...
const EXPERIENCE_CTAS = {
  default: {
    ...
    cta: { label: 'Find Your Brew Style', url: '/experiences/morning-minimalist' },
  ...
  'morning-minimalist': {
    ...
    cta: { label: 'See Your Setup', url: '/experiences/morning-minimalist' },
  ...
  upgrader: {
    ...
    cta: { label: 'Explore Upgrades', url: '/experiences/the-upgrade-path' },
  ...
  'craft-barista': {
    ...
    cta: { label: 'Build Your Station', url: '/experiences/craft-at-home' },
  ...
  traveller: {
    ...
    cta: { label: 'Pack Your Kit', url: '/experiences/espresso-anywhere' },
  ...
  'non-barista': {
    ...
    cta: { label: 'See How Easy It Is', url: '/experiences/the-non-barista' },
...
export function getNavigationOverride(personaTag) {
  const overrides = {
    'morning-minimalist': {
      ...
      cta: { label: 'Your Morning Setup', url: '/experiences/morning-minimalist' },
    },
    upgrader: {
